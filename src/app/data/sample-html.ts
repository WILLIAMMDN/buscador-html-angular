...
<html lang="es">
  ...
  <body>
    ...
    <p class="hint">Reduce el riesgo de acceso no autorizado porque solicita mas de una prueba de identidad.</p>
  </body>
</html>
`;
